...
POSTGRES_DATABASE = environ.get("POSTGRES_DATABASE", default="database")
POSTGRES_USERNAME = environ.get("POSTGRES_USERNAME", default="postgres")
POSTGRES_PASSWORD = environ.get("POSTGRES_PASSWORD", default="jaspreet")
...
from app.models.model_base import SqlDB

SqlDB().init_database(connection_config=CONNECTION_CONFIG)
